import type { GlobalData_ } from "./GlobalData";

interface GlobalEventProtocol {
	/** 玩家退出 */
	playerExit(player_: GlobalData_.PlayerData): void;
}

class GlobalEventTarget<CT> {
...
const globalEvent = new GlobalEventTarget<GlobalEventProtocol>();
